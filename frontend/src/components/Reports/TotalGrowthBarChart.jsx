...
// chart data
import data from './chart-data/total-growth-bar-chart';
...
const TotalGrowthBarChart = ({ isLoading, registers }) => {
  ...
  // const chartData = data(registers);
  useEffect(() => {
    setChartData(data(registers));
  }, [registers]);
